...
public class ReplaceTest {
    ...
    public void testInIsNull() {
        String[] same = { "I" };
        String[] displace = { "You" };
        assertNull(Use.replace(null, same, displace));
    }
    ...
    public void testSameIsNull() {
        String[] first = { "I", "know" };
        String[] displace = { "You" };
        assertNull(Use.replace(first, null, displace));
    }
    ...
    public void testDisplaceIsNull() {
        String[] first = { "I", "know" };
        String[] same = { "I" };
        assertNull(Use.replace(first, same, null));
    }

    @Test
    public void testInAndSameAreNull() {
        String[] displace = { "You" };
        assertNull(Use.replace(null, null, displace));
    }

    @Test
    public void testInAndDisplaceAreNull() {
        String[] same = { "I" };
        assertNull(Use.replace(null, same, null));
    }

    @Test
    public void testSameAndDisplaceAreNull() {
        String[] text = { "I", "know" };
        assertNull(Use.replace(text, null, null));
    }

    @Test
    public void testAllNull() {
        assertNull(Use.replace(null, null, null));
    }
    ...
    public void testNotSameLength() {
        ...
        assertNull(Use.replace(first, same, displace));
    }
    ...
    public void testNoChange() {
        ...
        assertEquals(first.length, result.length);

        for (int i = 0; i < first.length; i++) {
            assertEquals(first[i], result[i]);
        }
    }
